    ...
    ui(new Ui::Bento)
{
    ...
    //### Set up Interface ###
    QSound *note_do = new QSound(":/Sons/c1.wav");
    playlist.push_back(note_do);
    QSound *note_re=new QSound(":/Sons/d1.wav");
    playlist.push_back(note_re);
    QSound *note_mi=new QSound(":/Sons/e1.wav");
    playlist.push_back(note_mi);
    QSound *note_fa=new QSound(":/Sons/f1.wav");
    playlist.push_back(note_fa);
    QSound *note_sol=new QSound(":/Sons/g1.wav");
    playlist.push_back(note_sol);
    QSound *note_la=new QSound(":/Sons/a1.wav");
    playlist.push_back(note_la);
    QSound *note_si=new QSound(":/Sons/b1.wav");
    playlist.push_back(note_si);
